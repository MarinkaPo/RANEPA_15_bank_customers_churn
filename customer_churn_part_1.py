...
st.markdown('''<h3 style='text-align: center; color: #30BA8F;'
            >Bank customer churn prediction</h3>''', 
            unsafe_allow_html=True)
...
\n Задания будут включать 3 блока: на анализ данных, их визуализацию и прогноз оттока клиентов.
...
pipeline_bar.markdown(
    ...
    \n**Этапы:**
    \n1. Сбор данных:
    \nБыл использован учебный датасет по прогнозированию оттока банковских клиентов;
    \n2. Предобработка данных:
    \nС использованием библиотек [pandas](https://pandas.pydata.org/docs/user_guide/index.html), [matplotlib](https://matplotlib.org/stable/api/index.html), [numpy](https://numpy.org/doc/stable/reference/index.html);
    \n3. Анализ статистических показателей и графический анализ данных:
    \nС использованием библиотек [pandas](https://pandas.pydata.org/docs/user_guide/index.html), [matplotlib](https://matplotlib.org/stable/api/index.html);
