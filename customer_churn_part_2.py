...
# ---------------------Header---------------------
st.markdown('''<h1 style='text-align: center; color: #fe6c55;'  # #fe6c55  #F64A46
            >Прогноз оттока банковских клиентов</h1>''', 
            unsafe_allow_html=True)
st.markdown('''<h2 style='text-align: center; color: #42c4ac;'
...
st.write("""
Лабораторная работа *"Прогноз оттока банковских клиентов"* помогает на реальном примере понять, 
...
\nВо время выполнения лабораторной работы вы узнаете, как можно использовать машинное обучение для принятия решений в бизнесе, промышленности, продажах и не только.
\n* **Студентам направления аналитики и консалтинга:**
\nТак как машинное обучение помогает бизнес-анализу при поиске закономерностей в данных и постановке бизнес-гипотез.
\n* **Студентам маркетинговых направлений:**
\nПотому что для грамотного взаимодействия с клиентом нужно уметь предсказывать его поведение.
\n* **Студентам финансовых и экономических специальностей:**
\nВедь своевременное предсказание поведения клиентов - это одна из основ грамонтого распределения финансов компании. А общее понимание возможностей применения искуственного интеллекта для бизнеса помогает эффективнее управлять бюджетом.
\n* **Студентам других специальностей:**
\nДля общего понимания сфер применения искуственного интеллекта в разных сферах бизнеса.
""")
...
\n Задания *второй части лабораторной работы* будут включать 3 блока: обучение модели машинного обучения *без* корректировки данных, *с* корректировкой дисбаланса классов клиентов и непосредственно предсказание поведения клиентов лучшей моделью.
...
st.markdown('''<h2 style="text-align: left; color: black;">Блок 1: Обучение модели без балансировки классов </h2>''', 
            unsafe_allow_html=True)
...
st.markdown('''<h2 style="text-align: left; color: black;">Блок 2: Обучение модели с балансировки классов </h2>''', 
            unsafe_allow_html=True)
...
st.markdown('''<h2 style="text-align: left; color: black;">Блок 3: Предсказание лучшей моделью </h2>''', 
            unsafe_allow_html=True)
st.markdown('''\n Теперь воспользуемся нашей лучшей обученной моделью для предсказания поведения клиентов.
\n*Задание по Блоку 3:*
...
\n 3. Практически никогда не реализуют точный прогноз с первого раза: вначале используют базовую модель, а результаты последующих моделей сравнивают с результатами baseline-модели. Естественно, лучшей моделью считается та, что даёт более высокие метрики качества.''')
